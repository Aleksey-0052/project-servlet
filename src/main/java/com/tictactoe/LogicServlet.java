...
@WebServlet(name = "LogicServlet", value = "/logic")          // Добавляем маппинг (адрес, по которому этот servlet
public class LogicServlet extends HttpServlet {               // будет перехватывать запрос)
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Если пустой ячейки нет и никто не победил - значит это ничья
            ...
            // Получаем значения карты “field” в виде списка, отсортированного в порядке возрастания индексов.
    ...
    private boolean checkWin(HttpServletResponse response, HttpSession currentSession, Field field) throws IOException {
        // Получаем крестик, если ряд состоит только из крестиков, или нолик, если ряд состоит только из ноликов,
        // иначе пустоту
