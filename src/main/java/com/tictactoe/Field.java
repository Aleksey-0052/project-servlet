...
public class Field {
    ...
    // Возвращает значения карты “field” в виде списка, отсортированного в порядке возрастания индексов.
    ...
    // Проверяет, не завершена ли игра. Если есть ряд из трех крестиков – возвращает крестик, если из трех ноликов
    // – нолик. Иначе – пустоту.
